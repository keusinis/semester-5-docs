...
\end{itemize}
%navigation: The home window has 3 main entities: the left-side menu, food menu, that has food categories for faster filtering, and then order detail menu.
...
\subsubsection{IA structures} % idet map
...
Labels are clear and functional, mostly descriptive text based with the exception of some simple, standard icons for universal actions. %pridet pictogramas
